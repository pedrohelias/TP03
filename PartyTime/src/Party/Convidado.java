...
public class Convidado extends Pessoa{
	...
	protected Presente presenteConv;
	
	
	public Convidado(String no, String em, Telefone numero, int ida, int idzao, boolean pres, Presente presente) {
		super();
		this.nome = no;
		this.email = em;
	...
	public Presente getPresenteConv() {
		return presenteConv;
	}
	...
	public void setPresenteConv(Presente presenteConv) {
